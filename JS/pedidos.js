var UrlGetPedidos='http://localhost:90/G3_20/controller/pedidos.php?op=GetPedidos';
var UrlPostPedido='http://localhost:90/G3_20/controller/pedidos.php?op=InsertPedidos';
var UrlGetUno='http://localhost:90/G3_20/controller/pedidos.php?op=GetUno';
var UrlPutPedido='http://localhost:90/G3_20/controller/pedidos.php?op=UpdatePedidos';
var UrlDeletePedido='http://localhost:90/G3_20/controller/pedidos.php?op=DeletePedidos';
